...
public class MemKV  implements Serializable {
    ...
    public void put(String key, MemKV m) {
        hm.put( key, m);
    }
    ...
    public void put(String key, Double o) {
        hm.put(key, o);
    }
    ...
    public void put(String key, Float o){
        hm.put(key, o);
    }
    ...
    public void put(String key, Integer o){
        hm.put(key, o);
    }

    public void put(String key, int o) {
        hm.put(key, Integer.valueOf( o ));
    }

    public void put(String key, Boolean o){
        hm.put(key, o);
    }
    ...
    public void put(String key, BigInteger o){
        hm.put(key, o);
    }
    ...
    public MemKV getMemKV(String key) {
        Object o = hm.get( key );

        if ( ! (o instanceof MemKV) ) {
            throw(new IllegalArgumentException(vNotOfType("MemKV")));
        }
    ...
    public Date getDate(String key) {
        ...
        if ( ! (o instanceof Date) ) {
            throw(new IllegalArgumentException(vNotOfType("Date")));
        }
